...
This repository provides [SHACL](https://www.w3.org/TR/shacl/) shapes to review usage of the [(gentle) Unified Foundational Ontology](https://github.com/nemo-ufes/gufo) (gUFO).
